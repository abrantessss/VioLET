...
namespace autopilot {
  class CombinedVehicleController : public autopilot::Controller {
    ...
    protected:
      ...
      rclcpp::Publisher<geometry_msgs::msg::Vector3Stamped>::SharedPtr vertical_velocity_tracking_pub_;
      ...
      Eigen::Vector3d heading_sp_filtered_{Eigen::Vector3d::UnitX()};
      ...
      double tx_min_{0.0};
      double tx_max_{100.0};
      double tz_min_{0.0};
      double tz_max_{120.0};
      double u_cmd_debug_{0.0};
      double u_measured_debug_{0.0};
      double lateral_velocity_debug_{0.0};
      double zdot_measured_filtered_{0.0};
      double vertical_velocity_filter_tau_{0.2};
      Eigen::Vector3d inertial_velocity_debug_{Eigen::Vector3d::Zero()};
      double gamma_{0.0};
      double path_k1_{1.0};
      double path_k2_{1.0};
      double heading_slew_rate_{1.0};
      double path_guidance_update_rate_hz_{10.0};
      double path_guidance_elapsed_{0.0};
      double previous_yaw_target_raw_{0.0};
      double yaw_target_unwrapped_{0.0};
      double previous_yaw_measured_raw_{0.0};
      double yaw_measured_unwrapped_{0.0};
      ...
      bool heading_sp_filtered_initialized_{false};
      bool vertical_velocity_filter_initialized_{false};
      bool yaw_target_initialized_{false};
      bool yaw_measured_initialized_{false};
  };
}
